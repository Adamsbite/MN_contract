...
contract ERC721 is IERC721, IERC721Metadata {
     ...
     */
    // This is commented and it's now implement in the constructor of Diamond.sol
    ...
    function getApproved(uint256 tokenId) public view virtual override returns (address) {
        ...
        return nft._tokenApprovals[tokenId];
    }
    ...
    function isApprovedForAll(address owner, address operator) public view virtual override returns (bool) {
        return nft._operatorApprovals[owner][operator];
    }
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        // Clear approvals
        delete nft._tokenApprovals[tokenId];

        unchecked {
            // Cannot overflow, as that would require more tokens to be burned/transferred
            // out than the owner initially received through minting and transferring in.
            nft._balances[owner] -= 1;
        }
        delete nft._owners[tokenId];
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        nft._tokenApprovals[tokenId] = to;
    ...
    function _setApprovalForAll(
        ...
        nft._operatorApprovals[owner][operator] = approved;
    ...
    function _beforeConsecutiveTokenTransfer(
        ...
        if (from != address(0)) {
            nft._balances[from] -= size;
        }
        if (to != address(0)) {
            nft._balances[to] += size;
        }
    }
